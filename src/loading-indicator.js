...
export function LoadingIndicator () {
  ...
  <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" style={{margin: 'auto', background: 'transparent', display: 'block'}} width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
    <defs>
      <filter id="ldio-c5hltkz8gz-filter" x="-100%" y="-100%" width="300%" height="300%" colorInterpolationFilters="sRGB">
    ...
    <g filter="url(#ldio-c5hltkz8gz-filter)">
      ...
      <g>
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={0} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={1} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={2} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={3} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={4} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={5} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={6} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={7} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={8} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={9} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={10} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={11} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={12} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={13} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={14} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={15} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={16} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={17} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={18} fill="#fe718d" transform="scale(0.5)" />
        </g>
        ...
        <g transform="translate(50 20)">
          <circle cx={0} cy={0} r={19} fill="#fe718d" transform="scale(0.5)" />
        </g>
